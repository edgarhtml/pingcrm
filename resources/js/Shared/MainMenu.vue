<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/pagos">
        <icon name="dollar" class="mr-2 w-4 h-4" :class="isUrl('pagos') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('pagos') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Pagos</div>
      </Link>
    </div>
    <div class="mb-4">
